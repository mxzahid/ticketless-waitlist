      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground text-pretty">
            Be the first to know when TICKETLESS launches. No spam, just one email when it goes live.
          </p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  className="h-12 text-base"
                />
                <p className="text-sm text-muted-foreground mt-2">I will only text you once when the app launches.</p>
              </div>
